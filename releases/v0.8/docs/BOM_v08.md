...
| — | **v0.8 FASTENER STANDARD** | Every threaded joint is now an **M3 machine screw into an M3 brass heat-set** (super-refined printed prototype), with exactly TWO carve-outs, both forced by external parts: **solenoid** stays M2.5 (its own tabs are drilled M2.5), **PN532** stays M3 **nylon** into printed bosses (brass at the antenna corners kills read range). No self-tapping-into-plastic anywhere else. | — | — |
