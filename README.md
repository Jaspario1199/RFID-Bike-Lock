...
| [`CAD_AUDIT.md`](CAD_AUDIT.md) | **Build audit of the CNC casing (rev 3e)** — what `--audit` checks beyond the geometry gates (wire/connector envelopes, nuts, plugs, thread engagement, pin insertion, machining numerics), every defect it found and what moved |
| [`ASSEMBLY_CNC.md`](ASSEMBLY_CNC.md) | **The step-by-step build manual for the current CNC casing (rev 3e)** — print settings, every screw, bench checkpoints, stage-by-stage assembly, troubleshooting |
