...
| [`WIRING.md`](WIRING.md) | **The electrical build in detail** — power domains, full net list, the RC522 3.3 V trap, driver-card layout, build order with expected measurements, failure table |
