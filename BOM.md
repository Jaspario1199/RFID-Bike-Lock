...
| 21b | **Latch cap** (rev 3e) | Ø8 × 10 hardened steel cap, Ø10 × 2 rear flange, Ø6.1 × 8 bore over the HS-0730B plunger nose, Ø2 roll pin — the latch pin proper; made from Ø10 O1 / 4140 round stock | 1 | $3 stock |
| 21c | **Return spring** (rev 3e) | Ø9 OD × 10 free, ~0.4 N/mm, between the cap flange and the coil face — replaces the solenoid's tail spring/bolt (cut off) | 1 | $1 |
| 21d | **Mouth bushing** (rev 3e) | hardened, Ø10.3 ID × Ø14 OD × 10.5, pressed in the A1 boss through the lid; nearest stock is a DIN 179 10 mm drill bushing (Ø10 / Ø15 — ream + turn, or change the model) | 1 | $4 |
